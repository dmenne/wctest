  ...
  sidebarLayout(
    ...
    mainPanel("Daten: Zweispaltige Excel-Daten aus der Zwischenablage mit STRG-V hier eingeben",
      ...
      wellPanel(id = "results",
        ...
        plotOutput("diffplot"),
        HTML('<ul><li>Jeder Balken repräsentiert das 95%-Konfidenzintervale einer paarweisen Gruppendifferenz.</li><li>Wenn eine der Konfidenzbalken den Wert 0 NICHT kreuzt, ist diese Differenz signifikant von Null verschieden mit p<0.05.</li><li>Wenn alle Balken den Wert 0 kreuzen, wurde für keine Differenz ein signifikanter Effekt gefunden. Schreiben Sie bitte nicht: "Beide Behandlungsmethoden habe die gleiche Wirkung auf ...", sondern etwa: "Mit den Daten konnte ein Unterschied zwischen den beiden Behandlungsmethoden nicht nachgewiesen werden".</li><li>p-Werte werden hier bewusst nicht ausgegeben, da die Konfidenzintervalle aussagekräftiger sind.</li><li>Eine Korrektur für multiples Testen - Stichwort: Bonferroni - wurde nicht durchgeführt.<li>Um die Graphik zu speichern, verwenden Sie im Browser das Menü, das nach Rechtsklick erscheint.</li><li>In der Tabelle unten ist "estimate" die geschätzte Differenz für den Paarvergleich (difference in location): "lower" und "upper" sind die 95% Konfidenzgrenzen, bestimmt mit dem <a href="https://en.wikipedia.org/wiki/Hodges%E2%80%93Lehmann_estimator">Hodges-Lehman Schätzer.</a></li><li>Falls Sie die Werte dieser Tabelle in Ihre Arbeit übernehmen, reduzieren Sie bitte die Anzahl Kommastellen einheitlich; in der hier wiedergegebenen Tabelle sind es zu viele!</li></ul>'),
